...
@{EXPECTED_THAI_TEXTS}    สถิติจำนวนบทความทั้งหมด 5 ปี    สถิติจำนวนบทความที่ได้รับการอ้างอิง
@{EXPECTED_ENGLISH_TEXTS}    Total number of articles statistics for 5 years    Statistics on the number of articles cited
